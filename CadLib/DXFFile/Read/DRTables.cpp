 ...
 *-------------------------------------------------------------------*/
DWORD64 ReadTableTypeName( PDXF pDxf )
{
	int		GCode;
	char	strValue[2048];
...
/*-------------------------------------------------------------------*
 ...
 |  Output: TableType Code else TAB_NOTSET                           |
 *-------------------------------------------------------------------*/
DWORD64 dxfReadTableTypeName( HDXF hDxf )
{
	PDXF	pDxf;
	int		GCode;
	char	strValue[2048];
 ...
 *-------------------------------------------------------------------*/
DWORD64 dxfGetCurrentTableType( HDXF hDxf )
{
	PDXF	pDxf;
	DWORD64	result;
...
/*-------------------------------------------------------------------*
 ...
 |  Output: TableType Code else TAB_NOTSET                           |
 *-------------------------------------------------------------------*/
DWORD64 dxfFindNextTableType( HDXF hDxf )
{
	PDXF	pDxf;
	DWORD64	result;
...
/*-------------------------------------------------------------------*
 ...
 |  Output: TableType Code else TAB_NOTSET                           |
 *-------------------------------------------------------------------*/
DWORD64 dxfReadTableType( HDXF hDxf, LPVOID pTableType )
{
	PDXF	pDxf;
	int		GCode;
	char	strValue[2048];
