...
typedef struct tag_DRAWING
{
	...
	DWORD64		BlocksNumber;
	DWORD64		CurrentBlock;

	OBJHANDLE	LastObjhandle;
	DWORD64		LastDimBlkNum;
...
OBJHANDLE drwFindTableType_Direct(
	...
	DWORD64		dwTableType,		// table type to get data ( TAB_NOTSET = search in all table types )
...
OBJHANDLE drwFindEntity_Direct(
	...
	DWORD64			dwFindType,		// find type
	DWORD64*			pdwEntityPos=NULL// position of found entity
);
