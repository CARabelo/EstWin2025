...
typedef std::pair<double, double> typairdouble;
typedef std::array<typairdouble,5> tyarrpairdouble;
//typedef tyarrpairdouble::iterator ittyarrpairdouble;
...
//    public static void Init(double a, double f)
    ...
    */
    ...
    tyarrpairdouble Datum;

    int NumDatum;

public: 

  Gdc_To_Utm_Converter(int iDatum);
...
public: 
  static void ConvertGDC_UTM(const tylstGdc_Coord_3d& LstCoordGdc,tylstUtm_Coord_3d& LstCoordUTM);
