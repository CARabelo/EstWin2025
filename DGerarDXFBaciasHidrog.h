#if !defined(AFX_DGERARDXF_H__44367555DC_F7B9_4F9F_B3FE_4E3A85AB65FB__INCLUDED_)
#define AFX_DGERARDXF_H__44367555DC_F7B9_4F9F_B3FE_4E3A85AB65FB__INCLUDED_
...
class CDGerarDXFBaciaHidrog : public CDialog
{
 ...
 inline void CDGerarDXFBaciaHidrog::ConvPRealPVertex(REALPOINT& Vertex,const Ponto& P)   //--- converte coordenadas reais para coordenadas do vídeo
  {
  ...
  // Construction
public:
  CDGerarDXFBaciaHidrog(CWnd* pParent = NULL,CString& NomeProj = CString(""),CString& NomeProjBase = CString(""),double pCx=0.0,double pCy=0.0, double pEscala=1.0);   // standard constructor

  // Dialog Data
  //{{AFX_DATA(CDGerarDXFBaciaHidrog)
  ...
  //{{AFX_VIRTUAL(CDGerarDXFBaciaHidrog)
protected:
...
#endif // !defined(AFX_DGERARDXF_H__44367555DC_F7B9_4F9F_B3FE_4E3A85AB65FB__INCLUDED_)
